...
def set_alert(action):
  if action == "joury0":
    ...
    lbl_j0.grid( row=1, column=0, padx='5', pady='5', sticky='ew' )
    ...
    lbl_j1.grid( row=1, column=1, padx='5', pady='5', sticky='ew' )
    ...
    lbl_j2.grid( row=1, column=2, padx='5', pady='5', sticky='ew' )
